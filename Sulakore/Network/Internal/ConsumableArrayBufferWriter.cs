...
internal sealed class ConsumableArrayBufferWriter : IBufferWriter<byte>, IDisposable
{
    ...
    /// <summary>
    /// Creates an instance of an <see cref="ConsumableArrayBufferWriter"/>, in which data can be written to,
    ...
    /// <summary>
    /// Notifies <see cref="ConsumableArrayBufferWriter"/> that <paramref name="count"/> amount of data was consumed from the output <see cref="Span{byte}"/>/<see cref="Memory{byte}"/ and can be overwritten>
    /// </summary>
    /// <exception cref="ArgumentException">
    /// Thrown when <paramref name="count"/> is negative.
    /// </exception>
    ...
    public void Consume(int count)
    {
        ...
        int newConsumedCount = _consumedCount + count;
        ...
        else _consumedCount = newConsumedCount;
    }
    ...
    private void CheckAndResizeBuffer(int sizeHint)
    {
        ...
        {
            int countUnconsumed = _index - _consumedCount;
            int countAvailable = _buffer.Length - countUnconsumed;
            ...
            {
                int growBy = Math.Max(sizeHint - _consumedCount, _buffer.Length);
                ...
                byte[] destinationArray = ArrayPool<byte>.Shared.Rent(newSize);
